...
import ch.ethz.inf.vs.appserver.cfg.Config;
import ch.ethz.inf.vs.appserver.install.InstallResource;
import ch.ethz.inf.vs.appserver.plugnplay.AbstractApp;
 ...
 * Actinium
 * <p>
 * An app server creates a structure of CoAP resources to run arbitrary
 ...
 */
public class AppServer extends LocalEndpoint {
	 ...
	 */
	public AppServer(Config config) throws SocketException {
		this.config = config;
