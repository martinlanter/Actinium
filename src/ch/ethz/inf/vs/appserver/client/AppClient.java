package ch.ethz.inf.vs.appserver.client;
 ...
 * java -cp bin;../Californium/bin ch.ethz.inf.vs.appserver.AppClient
 * 
 * @author Martin Lanter
 */
public class AppClient extends JPanel {

	private static final String DEFAULT_PATH = "coap://localhost:5683";
	...
	public AppClient() {
		...
		cboTarget.setSelectedItem(DEFAULT_PATH);
		...
		splCE.setLeftComponent(splReqRes);
		splCE.setRightComponent(panelE);
		add(splCE);
	...
	private void discover() {
		...
		request.registerResponseHandler(new ResponseHandler() {
			public void handleResponse(Response response) {
				...
				cboTarget.setModel(new DefaultComboBoxModel(ress1.toArray()));
				populateTree(ress2);
			}
		});
		execute(request);
