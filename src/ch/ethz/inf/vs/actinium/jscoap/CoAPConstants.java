...
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Accept;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Bad_Gateway;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Bad_Option;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Bad_Request;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Changed;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Content;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Content_Type;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Created;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Deleted;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.ETag;
...
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Max_Age;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Method_Not_Allowed;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Not_Found;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Not_Implemented;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Precondition_Failed;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Proxy_Uri;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Proxying_Not_Supported;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Request_Entity_Too_Large;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Service_Unavailable;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Token;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Unauthorized;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Unsupported_Media_Type;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Uri_Host;
import static ch.ethz.inf.vs.actinium.jscoap.CoAPConstants.Uri_Path;
